...
\multirow{-9}{*}{ETSI} & NFV ISG (Release 3) & \multirow{-9}{*}{NFV} & \cellcolor{gray!25} Report on architecture options to support multiple
...
& & & \cellcolor{gray!25} White Paper: Next Generation Networks~\cite{NGMNAlliance20155GPaper} \\
\multirow{-2}{*} { NGMN } & \multirow{-2}{*} { Work Programme} & \multirow{-2}{*} { 5G Network } & 5G Network and Service Management and Orchestration~\cite{NGMN:5G:2017} \\ \hline
...
&&& \cellcolor{gray!25}TOSCA version 1.0~\cite{OASIS2013Topology1.0}\\
&&& TOSCA for NFV Version 1.0~\cite{OASIS2017TOSCA1.0}\\
\multirow{-3}{*} {OASIS} & \multirow{-3}{*} {TOSCA} & \multirow{-3}{\linewidth} {Resource and Service Modeling} & \cellcolor{gray!25} TOSCA in YAML Version 1.2~\cite{OASIS2017TOSCA1.2} \\ \hline
