...
\journal{Computer Communications (Accepted for publication)}
...
\fntext[*]{Any feedback is welcome to improve the work turning the \textit{github} and \textit{arxiv} versions of this publication a ``living document'' driven by community contributions as NSO evolves.  Do not hesitate to contact the authors and submit \textit{github} pull requests or issues: 
...
\input{TEXs/01_Introduction}
\input{TEXs/02_Background.tex}
\input{TEXs/03_Enabling_Scenarios.tex}
\input{TEXs/04_NSO.tex}
\input{TEXs/05_NSO_Standardization.tex}
\input{TEXs/06_Projects.tex}
\input{TEXs/07_Solutions.tex}
\input{TEXs/08_Challenges.tex}
\input{TEXs/09_Conclusions.tex}
